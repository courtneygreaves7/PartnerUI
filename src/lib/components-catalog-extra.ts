...
<DashboardFilterBar filters={filters} onRun={onRun} />`,
  },
  {
    ...
    category: "insights",
    description: "ReportSection with MetricTrendWidget total bookings, ProductSplitWidget, and optional partner breakdown table.",
...
<BookingsSnapshot filters={filters} />`,
  },
  {
    ...
    category: "insights",
    description: "CAL customer price gauge, ABV excl/inc benchmark widgets, and optional partner ABV table.",
...
<CalFinancials filters={filters} />`,
  },
  {
    ...
    name: "TimingSnapshot",
    category: "insights",
    description: "Avg booking lead MetricBenchmarkWidget, cancellation headline, and optional partner breakdown table.",
