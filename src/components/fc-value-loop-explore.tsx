  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          type="button"
          className="h-10 w-full rounded-md outline-none transition-[transform,box-shadow] hover:scale-[1.02] hover:shadow-sm focus-visible:ring-2 focus-visible:ring-ring/40"
          style={{
